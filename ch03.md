...
在學習 Objective-C 的過程中，我們常常會看到 NS\*\* 為字首的函式，像是這個章節或之前章節有看過的 `NSLog`,`NSString`...，為什麼是 NS 開頭呢？ 這跟 Objective-C 的歷史因素有關，在 1980 年，賈伯思離開蘋果創立 NeXT，開發了NeXTSTEP 的作業系統。其實這些 NS 為字首的函式都是使用 NextStep 這套函數庫的函式， NS 代表著 「N」ext「S」tep。
